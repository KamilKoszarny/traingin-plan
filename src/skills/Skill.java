...
JAVA ("Java", 0, null, 8, 1),
    ...
    FRAMEWORKS ("Frameworks", 1, JAVA, 8, 1),
        ...
        JPA("JPA", 2, FRAMEWORKS, 7, 1),
            HIBERNATE("Hibernate", 3, JPA, 10, 1),
    ...
    TOOLS ("Tools", 1, JAVA, 6, 3),
        ...
        AUTOMATION("Automation", 2, TOOLS, 6, 1),
            ...
            MAVEN("Maven", 3, AUTOMATION, 8, 5),
            GRADLE("Gradle", 3, AUTOMATION, 8, 1),
            ANT("Ant", 3, AUTOMATION, 5, 1),
    ...
    WEB("Web", 1, JAVA, 7, 1),
        SERVLETS("Servlets", 2, WEB, 8, 1),
            JSP("JSP", 3, SERVLETS, 8, 1),
            JSF("JSF", 3, SERVLETS, 9, 1),
        SERVERS("Servers", 2, WEB, 7, 1),
            TOMCAT("TomCat", 3, SERVERS, 6, 1),
            GLASS_FISH("GlassFish", 3, SERVERS, 4, 1),
        APACHE("Apache", 2, WEB, 6, 1),
    ...
    OTHER_LANGUAGES("Other languages", 1, JAVA, 4, 1),
        ...
        WEB_LANG("Web languages", 2, OTHER_LANGUAGES, 7, 1),
            HTML("HTML", 3, WEB_LANG, 7, 2),
                HTML5("HTML 5", 4, HTML, 8, 2),
                THYMELEAF("Thymeleaf", 4, HTML, 6, 1),
            CSS("CSS", 3, WEB_LANG, 6, 2),
                RWD("RWD", 4, CSS, 5, 1),
            PHP("PHP", 3, WEB_LANG, 7, 1),
            CMS("CMS", 3, WEB_LANG, 4, 1),
            XML("XML", 3, WEB_LANG, 5, 2),
                SOAP("SOAP", 4, XML, 5, 1),
